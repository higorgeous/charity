...
const TermsScreen = () => (
  <Wrapper>
    ...
    <p>
      This website is operated by Gorgeous. Throughout the site, the terms “we”,
      “us” and “our” refer to Gorgeous. Gorgeous offers this website, including
    ...
    <p>
      By visiting our site and/ or voting on a listing and/ or providing
      information, you engage in our “Service” and agree to be bound by the
      following terms and conditions (“Terms of Service”, “Terms”), including
      ...
      of the site, including without limitation users who are browsers, and/ or
      ...
      the website, you agree to be bound by these Terms of Service. If you do
    ...
    <p>
      You may not use our website for any illegal or unauthorized purpose nor
    ...
    <p>
      You understand that your content (not including web3 wallet information),
    ...
    <p>
      ...
      the website. These products or services may have limited availability and
    ...
    <p>
      ...
      and images of the listings that appear at the website. We cannot guarantee
      that your computer monitor&#39;s display of any color will be accurate. We
      reserve the right, but are not obligated, to limit the availability of our
      ...
      availability of any services that we offer. All descriptions of listings
      or content are subject to change at anytime without notice, at the sole
      discretion of us. We reserve the right to discontinue any service at any
      time.
    </p>
    <p>
      We do not warrant that the quality of any services, information, or other
      material shown or obtained to you will meet your expectations, or that any
    ...
    <p>
      ...
      charity entries) or without a request from us you send creative ideas,
    ...
    <p>
      ...
      to charity descriptions and listing information. We reserve the right to
    ...
    <p>
      ...
      durability, title, and non-infringement. In no case shall Gorgeous, our
      ...
      of the service procured using the service, or for any other claim related
      ...
      (or product) posted, transmitted, or otherwise made available via the
    ...
    <p>
      You agree to indemnify, defend and hold harmless Gorgeous and our parent,
    ...
    <p>
      ...
      <a href="mailto:info@higorgeous.io">info@higorgeous.io</a>.
    </p>
  </Wrapper>
);
