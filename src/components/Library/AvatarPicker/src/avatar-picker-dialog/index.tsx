...
import ModalDialog, { ModalFooter } from '@discovr/core.modal-dialog';
import { CustomThemeButton as Button } from '@discovr/core.button';
import { fileToDataURI, dataURItoFile, messages } from '@discovr/media.ui';
...
> {
  ...
  headerContent = () => {
    ...
    return (
      <ModalHeader>
        {title || this.props.translate('common.media.upload-an-avatar')}
      </ModalHeader>
    );
  };
    ...
    return (
      <ModalFooter>
        <ModalFooterButtons>
          ...
          >
            {primaryButtonText || this.props.translate('common.media.save')}
          </Button>
          <Button appearance="default" onClick={onCancel}>
            {this.props.translate('common.media.cancel')}
          </Button>
        </ModalFooterButtons>
      </ModalFooter>
    );
