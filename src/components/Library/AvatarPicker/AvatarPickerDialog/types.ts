...
import { CropProperties } from '../ImageNavigator';
...
export interface AvatarPickerDialogProps {
  /** This property is used to provide an array of pre-defined avatars. The **Avatar** object is a simple type with a single **dataURI: string** property. For convenience, this type is exported from the **@discovr/media.avatar-picker** module along with the **AvatarPickerDialog** component. */
