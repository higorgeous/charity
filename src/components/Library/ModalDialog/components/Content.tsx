...
export default class Content extends React.Component<Props, State> {
  ...
  componentDidMount() {
    ...
    if (this.props.header) {
      console.warn(
        "@discovr/modal-dialog: Deprecation warning - Use of the header prop in ModalDialog is deprecated. Please compose your ModalDialog using the 'components' prop instead",
      );
    }
    if (this.props.footer) {
      console.warn(
        "@discovr/modal-dialog: Deprecation warning - Use of the footer prop in ModalDialog is deprecated. Please compose your ModalDialog using the 'components' prop instead",
      );
    }
    if (this.props.body) {
      console.warn(
        "@discovr/modal-dialog: Deprecation warning - Use of the body prop in ModalDialog is deprecated. Please compose your ModalDialog using the 'components' prop instead",
      );
    }
    ...
    if (this.props.components.Body) {
      if (!(this.scrollContainer instanceof HTMLElement)) {
        console.warn(
          '@discovr/modal-dialog: Warning - Ref must attach to a DOM element; check you are using forwardRef and attaching the ref to an appropriate element. Check the examples for more details.',
        );
      }
    }
  ...
  determineKeylines: any = rafSchedule(() => {
